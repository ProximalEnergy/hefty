...
def get_kpi_data(
    *,
    ...
    Args:
        ...
        project_ids (list[UUID], optional): A list of project IDs to filter the
            KPI data. Defaults to an empty list.
        kpi_type_ids (list[int], optional): A list of KPI type IDs to filter the
            KPI data. Defaults to an empty list.
        include_device_data (bool, optional): A flag indicating whether to
            include device data in the query. Defaults to True.
    ...
    # NOTE: This function returns a pandas DataFrame using the read_sql method
