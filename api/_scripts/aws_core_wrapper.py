#!/usr/bin/env python3
"""
Python wrapper for update_core.sh script.
...
def main():
    """Execute the update_core.sh script."""
    # Get the project root directory (go up from _scripts to project root)
    project_root = Path(__file__).parent.parent
    script_dir = project_root / "_scripts"
    shell_script = script_dir / "update_core.sh"
