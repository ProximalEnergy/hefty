...
class DownloadSensorBess(FieldRegistry[SensorProtocol]):
    ...
    project_total_energy_charged_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.METER_ENERGY_IMPORTED_TO_PROJECT,
        project_level=True,
        scale=1000,
    )
    ...
    project_total_aux_energy_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_MV_AUX_METER_ENERGY_IMPORTED_TO_PROJECT,
        project_level=True,
        scale=1000,
    )
    ...
    circuit_total_energy_charged_raw_kwh_5m = sensor_field(
        sensor_type=(
            SensorTypeEnum.BESS_MV_COLLECTOR_CIRCUIT_METER_ENERGY_IMPORTED_TO_PROJECT
        ),
        scale=1000,
    )
    ...
    circuit_total_energy_discharged_raw_kwh_5m = sensor_field(
        sensor_type=(
            SensorTypeEnum.BESS_MV_COLLECTOR_CIRCUIT_METER_ENERGY_EXPORTED_TO_GRID
        ),
        scale=1000,
    )
    ...
    pcs_total_energy_charged_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_PCS_CHARGE_ENERGY_TOTAL,
        scale=1000,
    )

    pcs_total_energy_discharged_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_PCS_DISCHARGE_ENERGY_TOTAL,
        scale=1000,
    )
    ...
    pcs_module_total_energy_discharged_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_PCS_MODULE_DISCHARGE_ENERGY_TOTAL,
        scale=1000,
    )

    pcs_module_total_energy_charged_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_PCS_MODULE_CHARGE_ENERGY_TOTAL,
        scale=1000,
    )
    ...
    string_total_energy_charged_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_CHARGE_ENERGY_TOTAL,
        scale=1000,
    )

    string_total_energy_discharged_raw_kwh_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_DISCHARGE_ENERGY_TOTAL,
        scale=1000,
    )
    ...
    project_power_raw_kw_5m = sensor_field(
        sensor_type=SensorTypeEnum.METER_ACTIVE_POWER,
        project_level=True,
        scale=1000,
    )
    ...
    pcs_power_raw_kw_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_PCS_AC_POWER,
        scale=1000,
    )
    ...
    string_power_raw_kw_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_POWER,
        scale=1000,
    )
    ...
    project_soc_raw_5m = sensor_field(
        sensor_type=SensorTypeEnum.PROJECT_SOC_PERCENT,
        project_level=True,
    )

    bank_soc_raw_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_BANK_SOC_PERCENT,
    )

    block_soc_raw_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_BLOCK_SOC_PERCENT,
    )

    string_soc_raw_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_SOC_PERCENT,
    )
    ...
    bank_soh_raw_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_BANK_SOH_PERCENT,
    )

    string_soh_raw_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_SOH_PERCENT,
    )
    ...
    string_current_raw_amps_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_CURRENT,
    )
    ...
    string_avg_cell_temp_raw_c_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_AVG_CELL_TEMPERATURE,
    )
    string_min_cell_temp_raw_c_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_MIN_CELL_TEMPERATURE,
    )
    string_max_cell_temp_raw_c_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_MAX_CELL_TEMPERATURE,
    )
    string_min_module_temp_raw_c_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_MIN_MODULE_TEMPERATURE,
    )

    string_max_module_temp_raw_c_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_MAX_MODULE_TEMPERATURE,
    )

    string_avg_module_temp_raw_c_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_AVG_MODULE_TEMPERATURE,
    )
    ...
    string_avg_cell_voltage_raw_v_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_AVG_CELL_VOLTAGE,
    )

    string_min_cell_voltage_raw_v_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_MIN_CELL_VOLTAGE,
    )

    string_max_cell_voltage_raw_v_5m = sensor_field(
        sensor_type=SensorTypeEnum.BESS_STRING_MAX_CELL_VOLTAGE,
    )
