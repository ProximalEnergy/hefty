...
class DownloadSensorPv(SensorSchema):
    project_total_delivered_energy_raw_kwh_5m = field(
    ...
    inverter_module_ac_power_raw_kw_5m = field(
        sensor_type=SensorType.PV_INVERTER_MODULE_AC_POWER,
        scale=1000,
    )

    inverter_module_voltage_raw_v_5m = field(
        sensor_type=SensorType.PV_INVERTER_MODULE_DC_VOLTAGE,
    )

    project_power_setpoint_raw_kw_5m = field(
