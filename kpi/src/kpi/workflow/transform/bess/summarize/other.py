...
class TransformBessSummarizeOther(CalcSchema):
    ...
    @method_calc
    def bank_soh_d(
        soh: xr.DataArray = Input(Clean.bank_soh_5m.name),
    ...
    def project_bank_soh_d(
        soh: xr.DataArray = Input(bank_soh_d.name),
    ) -> xr.DataArray:
    ...
    @method_calc
    def string_soh_d(
        soh: xr.DataArray = Input(Clean.string_soh_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
        return soh.groupby(date_local(date_local_5m)).first()
    ...
    def project_string_soh_d(
        soh: xr.DataArray = Input(string_soh_d.name),
    ) -> xr.DataArray:
    ...
    def project_string_degradation_d(
        soh: xr.DataArray = Input(project_string_soh_d.name),
    ) -> xr.DataArray:
        return diff(soh, time_dim=TimeCoords.DATE_LOCAL)
    ...
    def string_min_module_temp_d(
        temp: xr.DataArray = Input(Clean.string_min_module_temp_c_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
    ...
    def project_string_min_module_temp_d(
        temp: xr.DataArray = Input(string_min_module_temp_d.name),
    ) -> xr.DataArray:
    ...
    def string_max_module_temp_d(
        temp: xr.DataArray = Input(Clean.string_max_module_temp_c_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
    ...
    def project_string_max_module_temp_d(
        temp: xr.DataArray = Input(string_max_module_temp_d.name),
    ) -> xr.DataArray:
    ...
    def string_avg_module_temp_d(
        temp: xr.DataArray = Input(Clean.string_avg_module_temp_c_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
    ...
    def string_avg_cell_temperature_d(
        temp: xr.DataArray = Input(Clean.string_avg_cell_temp_c_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
        return temp.groupby(date_local(date_local_5m)).mean()
    ...
    def string_max_cell_temperature_d(
        temp: xr.DataArray = Input(Clean.string_max_cell_temp_c_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
        return temp.groupby(date_local(date_local_5m)).max()
    ...
    def project_max_cell_temperature_d(
        temp: xr.DataArray = Input(string_max_cell_temperature_d.name),
    ) -> xr.DataArray:
        return temp.max(dim=coord(DeviceType.BESS_STRING))
    ...
    def string_min_cell_temperature_d(
        temp: xr.DataArray = Input(Clean.string_min_cell_temp_c_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
        return temp.groupby(date_local(date_local_5m)).min()
    ...
    def project_min_cell_temperature_d(
        temp: xr.DataArray = Input(string_min_cell_temperature_d.name),
    ) -> xr.DataArray:
        return temp.min(dim=coord(DeviceType.BESS_STRING))
    ...
    def string_min_cell_voltage_d(
        voltage: xr.DataArray = Input(Clean.string_min_cell_voltage_v_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
    ...
    def project_min_cell_voltage_d(
        voltage: xr.DataArray = Input(string_min_cell_voltage_d.name),
    ) -> xr.DataArray:
    ...
    def string_avg_cell_voltage_d(
        voltage: xr.DataArray = Input(Clean.string_avg_cell_voltage_v_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
    ...
    def string_max_cell_voltage_d(
        voltage: xr.DataArray = Input(Clean.string_max_cell_voltage_v_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
    ...
    def project_max_cell_voltage_d(
        voltage: xr.DataArray = Input(string_max_cell_voltage_d.name),
    ) -> xr.DataArray:
    ...
    def string_avg_current_amps_d(
        current: xr.DataArray = Input(Clean.string_current_amps_5m.name),
        date_local_5m: xr.DataArray = Input(Eval.date_local_5m.name),
    ) -> xr.DataArray:
    ...
    def project_max_string_current_amps_d(
        current: xr.DataArray = Input(string_max_current_amps_d.name),
    ) -> xr.DataArray:
    ...
    def project_min_string_current_amps_d(
        current: xr.DataArray = Input(string_min_current_amps_d.name),
    ) -> xr.DataArray:
