...
export const ExpectedMetricIdEnum = {
...
export const FailureModeEnum = {
  UNKNOWN: 1,
  PROJECT_OFFLINE: 2,
  PROJECT_UNDERPERFORMING: 3,
  PV_PCS_OFFLINE: 4,
  PV_PCS_UNDERPERFORMING: 5,
  PV_PCS_MODULE_OFFLINE: 6,
  PV_PCS_MODULE_UNDERPERFORMING: 7,
  PV_BLOCK_OFFLINE: 8,
  PV_BLOCK_UNDERPERFORMING: 9,
  PV_DC_COMBINER_OFFLINE: 10,
  PV_DC_COMBINER_UNDERPERFORMING: 11,
  TRACKER_OFFLINE: 12,
  TRACKER_UNDERPERFORMING: 13,
  PV_PCS_MODULE_DC_UNDERVOLTAGE: 14,
  PV_PCS_MODULE_DC_OVERVOLTAGE: 15,
  PV_PCS_MODULE_AC_UNDERVOLTAGE: 16,
  PV_PCS_MODULE_AC_OVERVOLTAGE: 17,
  PV_PCS_MODULE_UNDERFREQUENCY: 18,
  PV_PCS_MODULE_OVERFREQUENCY: 19,
  PV_PCS_MODULE_CONTACTOR_FAULT: 20,
  PV_PCS_MODULE_ISLANDING_PROTECTION: 21,
  PV_PCS_MODULE_SENSOR_FAILURE: 22,
  PV_PCS_MODULE_PDP_PROTECTION: 23,
  PV_PCS_MODULE_MODULE_OVERTEMPERATURE: 24,
  PV_PCS_MODULE_REACTOR_OVERTEMPERATURE: 25,
  PV_PCS_MODULE_TRANSFORMER_OVERTEMPERATURE: 26,
  PV_PCS_MODULE_DC_LEAKAGE_CURRENT_PROTECTION: 27,
  PV_PCS_MODULE_AC_LEAKAGE_CURRENT_PROTECTION: 28,
  PV_PCS_MODULE_OVERLOAD_PROTECTION: 29,
  PV_PCS_MODULE_GFDI_PROTECTION: 30,
  PV_PCS_MODULE_FAN_FAULT: 31,
  PV_PCS_MODULE_DC_FUSE_FAULT: 32,
  PV_PCS_MODULE_DETECTION_FUSE_FAULT: 33,
  PV_PCS_MODULE_DC_OVERCURRENT: 34,
  PV_PCS_MODULE_AC_OVERCURRENT: 35,
  PV_PCS_MODULE_FREQUENCY_ABNORMAL: 36,
  PV_PCS_MODULE_TEMPERATURE_ABNORMAL: 37,
  PV_PCS_MODULE_HARDWARE_FAULT: 38,
  PV_PCS_MODULE_GROUNDING_FAULT: 39,
  PV_PCS_MODULE_BUS_OVERVOLTAGE: 40,
  PV_PCS_MODULE_BUS_UNDERVOLTAGE: 41,
  PV_PCS_MODULE_INVERTER_OVERVOLTAGE: 42,
  PV_PCS_MODULE_INSULATION_IMPEDANCE: 43,
  PV_PCS_MODULE_AC_SPD_FAULT: 44,
  PV_PCS_MODULE_SAMPLING_FAULT: 45,
  PV_PCS_MODULE_PV_POLARITY_REVERSED: 46,
  PV_PCS_MODULE_CONTROL_POWER_SUPPLY_ABNORMAL: 47,
  PV_PCS_MODULE_BACKUP_POWER_SUPPLY_ABNORMAL: 48,
  PV_PCS_MODULE_AC_CURRENT_UNBALANCE: 49,
  PV_PCS_MODULE_AC_FUSE_FAULT: 50,
  PV_PCS_MODULE_DC_SPD_FAULT: 51,
  PV_PCS_MODULE_BUFFER_CONTACTOR_FAULT: 52,
  PV_PCS_MODULE_DC_INJECTION_FAULT: 53,
  PV_PCS_MODULE_DC_SWITCH_FAULT: 54,
  PV_PCS_MODULE_DEVICE_CODE_REPEAT_FAULT: 55,
  PV_PCS_MODULE_PARALLEL_OPERATION_COMMUNICATION_FAULT: 56,
  PV_PCS_MODULE_CONTROL_CABINET_TEMPERATURE_ABNORMAL: 57,
  PV_PCS_MODULE_DC_FUSE_GROUNDING_FAULT: 58,
  PV_PCS_MODULE_REVERSED_BRANCH_OVER_CURRENT: 59,
  PV_PCS_MODULE_GRID_VOLTAGE_UNBALANCE: 60,
  PV_PCS_MODULE_AC_CABINET_OVER_TEMPERATURE: 61,
  PV_PCS_MODULE_AC_SWITCH_DISCONNECTION: 62,
  PV_PCS_MODULE_AC_SWITCH_FAULT: 63,
  PV_PCS_MODULE_SOFT_START_FAULT: 64,
  PV_PCS_MODULE_DC_VOLTAGE_SAMPLING_FAULT: 65,
  PV_PCS_MODULE_FAN_2_FAULT: 66,
  PV_PCS_MODULE_CURRENT_UNBALANCE_2: 67,
  PV_PCS_MODULE_CURRENT_UNBALANCE_3: 68,
  PV_PCS_MODULE_DRIVE_BOARD_FAULT: 69,
  PV_PCS_MODULE_DC_CABINET_OVER_TEMPERATURE: 70,
  PV_PCS_MODULE_NEUTRAL_POINT_POTENTIAL_SHIFT: 71,
  PV_PCS_MODULE_CARRIER_SYNC_FAULT: 72,
  TRACKER_NON_COMMUNICATING: 73,
  TRACKER_NOT_FOLLOWING_SETPOINT: 74,
  TRACKER_MANUAL_MODE: 75,
  TRACKER_CLEAN_MODE: 76,
  TRACKER_FLOOD_STOW: 77,
  TRACKER_WIND_STOW: 78,
  TRACKER_SNOW_STOW: 79,
  TRACKER_PARKING_MODE: 80,
  TRACKER_MOW_STOW: 81,
  TRACKER_SNOW_SHED: 82,
  TRACKER_HAIL_STOW: 83,
  TRACKER_HURRICANE_STOW: 84,
  TRACKER_STOW_GENERIC: 85,
  GENERIC_ALARM: 86,
  BESS_BANK_OFFLINE: 87,
  BESS_BANK_UNDERPERFORMING: 88,
  BESS_STRING_OFFLINE: 89,
  BESS_STRING_UNDERPERFORMING: 90,
  BESS_PCS_OFFLINE: 91,
  BESS_PCS_UNDERPERFORMING: 92,
  TRACKER_FAULT: 93,
  DC_FIELD_UNDERPERFORMING: 94,
  PV_MV_CIRCUIT_OFFLINE: 95,
  BESS_PCS_MODULE_OFFLINE: 96,
  BESS_PCS_MODULE_UNDERPERFORMING: 97,
  BESS_BLOCK_OFFLINE: 98,
  BESS_BLOCK_UNDERPERFORMING: 99,
  BESS_PCS_MODULE_AC_UNDER_VOLTAGE: 100,
  BESS_PCS_MODULE_AC_OVER_VOLTAGE: 101,
  BESS_PCS_MODULE_AC_UNDER_FREQUENCY: 102,
  BESS_PCS_MODULE_AC_OVER_FREQUENCY: 103,
  BESS_PCS_MODULE_AC_CURRENT_IMBALANCE: 104,
  BESS_PCS_MODULE_PHASE_SEQUENCE_REVERSED: 105,
  BESS_PCS_MODULE_ANTI_ISLAND: 106,
  BESS_PCS_MODULE_AC_SHORT_CIRCUIT_PROTECTION: 107,
  BESS_PCS_MODULE_AC_CURRENT_ABNORMAL: 108,
  BESS_PCS_MODULE_PHASE_LOCKING_OUT: 109,
  BESS_PCS_MODULE_AC_VOLTAGE_TO_GROUND_ABNORMAL: 110,
  BESS_PCS_MODULE_OUTPUT_LEAKAGE_CURRENT_ABNORMAL: 111,
  BESS_PCS_MODULE_DC_COMPONENT_OF_INVERTER_VOLTAGE_ABNORMAL: 112,
  BESS_PCS_MODULE_AC_OVERCURRENT: 113,
  BESS_PCS_MODULE_AC_POWER_ABNORMAL: 114,
  BESS_PCS_MODULE_PRECHARGE_FAULT: 115,
  BESS_PCS_MODULE_THE_INDUCTANCE_VOLTAGE_ON_THE_GRID_SIDE_IS_TOO_HIGH: 116,
  BESS_PCS_MODULE_THE_TEMPERATURE_OF_THE_INDUCTANCE_ON_THE_GRID_SIDE_IS_TOO_HIGH: 117,
  BESS_PCS_MODULE_10_MINUTE_OVERVOLTAGE_IN_THE_POWER_GRID: 118,
  BESS_PCS_MODULE_BATTERY_OVER_VOLTAGE: 119,
  BESS_PCS_MODULE_BATTERY_INVERSE: 120,
  BESS_PCS_MODULE_BATTERY_OVER_CURRENT: 121,
  BESS_PCS_MODULE_INSULATION_RESISTANCE_ABNORMAL: 122,
  BESS_PCS_MODULE_BATTERY_TO_GROUND_VOLTAGE_ABNORMAL: 123,
  BESS_PCS_MODULE_BATTERY_FUSE_BREAK: 124,
  BESS_PCS_MODULE_U1BOARD_VERSION_FAULT: 125,
  BESS_PCS_MODULE_LEAKAGE_CURRENT_DETECTION_CIRCUIT_ABNORMAL: 126,
  BESS_PCS_MODULE_INVERTER_CURRENT_DETECTION_CIRCUIT_ABNORMAL: 127,
  BESS_PCS_MODULE_DC_CURRENT_DETECTION_CIRCUIT_ABNORMAL: 128,
  BESS_PCS_MODULE_AC_RELAY_OPEN_CIRCUIT: 129,
  BESS_PCS_MODULE_AC_RELAY_SHORT_CIRCUIT: 130,
  BESS_PCS_MODULE_DC_RELAY_OPEN_CIRCUIT: 131,
  BESS_PCS_MODULE_DC_POSITIVE_RELAY_CONTACT_SHORT_CIRCUIT: 132,
  BESS_PCS_MODULE_12V_POWER_SUPPLY_ABNORMAL: 133,
  BESS_PCS_MODULE_DRIVING_POWER_SUPPLY_ABNORMAL: 134,
  BESS_PCS_MODULE_5V_POWER_SUPPLY_ABNORMAL: 135,
  BESS_PCS_MODULE_RELAY_POWER_SUPPLY_ABNORMAL: 136,
  BESS_PCS_MODULE_POS_NEG_BUS_IMBALANCE: 137,
  BESS_PCS_MODULE_POS_BUS_OVER_VOLTAGE: 138,
  BESS_PCS_MODULE_NEG_BUS_OVER_VOLTAGE: 139,
  BESS_PCS_MODULE_BUS_OVER_VOLTAGE_SOFTWARE_PROTECTION: 140,
  BESS_PCS_MODULE_BUS_OVER_VOLTAGE_HARDWARE_PROTECTION: 141,
  BESS_PCS_MODULE_TOTAL_BUS_VOLTAGE_LOW: 142,
  BESS_PCS_MODULE_POS_BUS_SHORT_CIRCUIT: 143,
  BESS_PCS_MODULE_NEG_BUS_SHORT_CIRCUIT: 144,
  BESS_PCS_MODULE_TOTAL_BUS_SHORT_CIRCUIT: 145,
  BESS_PCS_MODULE_DC_VOLTAGE_DETECT_FAULT: 146,
  BESS_PCS_MODULE_CONVERSION_EFFICIENCY_ABNORMAL: 147,
  BESS_PCS_MODULE_DC_PARALLEL_CONNECTION_STATUS_ABNORMAL: 148,
  BESS_PCS_MODULE_DC_PARALLEL_POWER_ABNORMAL: 149,
  BESS_PCS_MODULE_INDUCTANCE_CURRENT_DETECTION_ABNORMAL: 150,
  BESS_PCS_MODULE_INDUCTANCE_CURRENT_ABNORMAL: 151,
  BESS_PCS_MODULE_INV_VOLT_ABNORMAL: 152,
  BESS_PCS_MODULE_PHASE_A_WAVE_LIMIT_CURR_PROTECT: 153,
  BESS_PCS_MODULE_PHASE_B_WAVE_LIMIT_CURR_PROTECT: 154,
  BESS_PCS_MODULE_PHASE_C_WAVE_LIMIT_CURR_PROTECT: 155,
  BESS_PCS_MODULE_PHASE_A_DRIVE_SIGNAL_GENERATION_ABNORMAL: 156,
  BESS_PCS_MODULE_PHASE_B_DRIVE_SIGNAL_GENERATION_ABNORMAL: 157,
  BESS_PCS_MODULE_PHASE_C_DRIVE_SIGNAL_GENERATION_ABNORMAL: 158,
  BESS_PCS_MODULE_IGBT_DRIVE_CABLE_FAULT: 159,
  BESS_PCS_MODULE_CARRIER_SYNCHRONIZATION_FAULT: 160,
  BESS_PCS_MODULE_POWER_FREQUENCY_SYNCHRONIZATION_FAULT: 161,
  BESS_PCS_MODULE_DC_SOFT_START_FAILURE: 162,
  BESS_PCS_MODULE_AC_SOFT_START_FAILURE: 163,
  BESS_PCS_MODULE_DC_SIDE_POWERABNORMAL: 164,
  BESS_PCS_MODULE_AC_CONTACTOR_OPEN_CIRCUIT_FAULT: 165,
  BESS_PCS_MODULE_DISCHARGE_RESISTANCE_OVER_TEMP: 166,
  BESS_PCS_MODULE_INVERTER_VOLTAGE_DETECTIONABNORMAL: 167,
  BESS_PCS_MODULE_AC_CAPACITOR_NEEDS_MAINTENANCE: 168,
  BESS_PCS_MODULE_AMBIENT_TEMP_TOO_HIGH: 169,
  BESS_PCS_MODULE_HIGH_DISCHARGE_RESISTANCE_TEMP: 170,
  BESS_PCS_MODULE_IGBT_OVERHEAT_PROTECTION: 171,
  BESS_PCS_MODULE_PCS_OVER_TEMP_RUN: 172,
  BESS_PCS_MODULE_CAPACITOR_OVER_TEMP: 173,
  BESS_PCS_MODULE_CAP_TEMP_DETECTION_NTC_ABNORMAL: 174,
  BESS_PCS_MODULE_CABIN_TEMP_1_NTC_ABNORMAL: 175,
  BESS_PCS_MODULE_CABIN_TEMP2_NTC_ABNORMAL: 176,
  BESS_PCS_MODULE_MODEL_CAPACITY_SETTING_ERROR: 177,
  BESS_PCS_MODULE_SYSTEM_PARAMETER_SETTINGERROR: 178,
  BESS_PCS_MODULE_CONTROL_BOARD_E2_STORAGE_ERROR: 179,
  BESS_PCS_MODULE_CONTROL_BOARD_FLASH_STORAGE_ERROR: 180,
  BESS_PCS_MODULE_CURR_WAVE_LIMIT_SETTING_ERROR: 181,
  BESS_PCS_MODULE_REAL_TIME_INFORMATION_ABNORMAL: 182,
  BESS_PCS_MODULE_SCHEDULING_INFORMATION_ABNORMAL: 183,
  BESS_PCS_MODULE_DISPATCHING_CAN_COMM_FAULT: 184,
  BESS_PCS_MODULE_STANDARD_MODULE_COMM_FAILURE: 185,
  BESS_PCS_MODULE_DSP_FPGA_SPI_ABNORMAL: 186,
  BESS_PCS_MODULE_FAST_MODULE_COMMABNORMAL: 187,
  BESS_PCS_MODULE_DSP_CLA_ABNORMAL: 188,
  BESS_PCS_MODULE_DSP_INTERRUPT_ABNORMAL: 189,
  BESS_PCS_MODULE_DSP_MAIN_LOOP_ABNORMAL: 190,
  BESS_PCS_MODULE_PARALLEL_CAN_ID_DUPLICATE: 191,
  BESS_PCS_MODULE_SINGLE_PCS_OVERLOAD: 192,
  BESS_PCS_MODULE_PARALLEL_PCS_SYSTEM_OVERLOAD: 193,
  BESS_PCS_MODULE_PARALLEL_PCS_CURRENT_BALANCE_FAULT: 194,
  BESS_PCS_MODULE_OFF_GRID_SYNCHRONIZATION_STARTUP_TIMEOUT: 195,
  BESS_PCS_MODULE_OFF_GRID_AC_VOLTAGE_PRESENT: 196,
  BESS_PCS_MODULE_ABNORMAL_OFFGRID_VOLTAGE_TRACKING: 197,
  BESS_PCS_MODULE_485_COMM_ABNORMAL: 198,
  BESS_PCS_MODULE_BMS_COMM_ABNORMAL: 199,
  BESS_PCS_MODULE_FAST_SCI_COMM_ABNORMAL: 200,
  BESS_PCS_MODULE_MODBUSTCP_COMM_ABNORMAL: 201,
  BESS_PCS_MODULE_DRY_CONTACT_QUICK_SHUTDOWN: 202,
  BESS_PCS_MODULE_REMOTE_EPO: 203,
  BESS_PCS_MODULE_SMOKE_ALARM: 204,
  PROJECT_CURTAILMENT: 205,
  PROJECT_RECLOSER_OPEN: 206,
  PROJECT_RECLOSER_PHASE_OPEN: 207,
  PROJECT_BREAKER_OPEN: 208,
  BESS_PCS_MODULE_GROUP_OFFLINE: 209,
  BESS_PCS_MODULE_GROUP_UNDERPERFORMING: 210,
} as const;
...
export const KPITypeEnum = {
  ...
  BESS_PROJECT_POI_POWER_AVAILABILITY: 126,
} as const;
...
export const ProjectIDEnum = {
  ...
  EL_CENTRO: "d7047189-8548-4bd9-a44d-e9021a054e7b",
  ...
  MUSTANG_HILLS: "fbb656c2-9ede-40b3-9bdd-89d2e1dcd643",
  MUSTANG_HILLS_BESS: "b7eb64c0-dceb-4c58-89c6-0b02808e6ad1",
  ...
  PRAIRIE_BREEZE_II: "dbb493ba-acf5-427d-9648-47f9ac666a0e",
  PRAIRIE_BREEZE_III: "8ee19feb-1b2d-4dc3-aa05-eb0d0d8d3a97",
  ...
  SKYHAWK: "cd617920-de65-48cd-a3ff-66272ba55b5e",
...
export const SensorTypeEnum = {
  ...
  PV_INVERTER_VOLTAGE_LL_AB: 133,
  PV_INVERTER_VOLTAGE_LL_BC: 134,
  PV_INVERTER_VOLTAGE_LL_CA: 135,
