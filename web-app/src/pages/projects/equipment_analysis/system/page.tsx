        ...
        <CustomCard
          ...
          info={
            <>
              ...
              power factor could be causing a loss of system performance if the
              grid is asking for reactive power. Power factor is a ratio of real
              power (the power that does work) to apparent power (the total
              power flowing in the circuit). When the power factor is low, it
              means that a larger portion of the power is reactive power, which
              does not perform useful work but is required by the grid to
        ...
        <CustomCard
          ...
          info={
            <>
              ...
              : Device has a child with an active Event. This propagates all the
              way up to the root device from any child.
              <br />
              &nbsp;&nbsp;&nbsp;&nbsp;
              <Text span c="green">
                Green
