...
Alembic is used to manage database migrations. Alembic directly compares the SQLAlchemy models defined in `app/models.py` with the current state of the database to detect any changes. Below are a few common commands used to run migrations:
