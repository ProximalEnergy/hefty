...
TEST_NAME = "test_double_black_diamond_combiner"
...
def test_double_black_diamond_combiner(monkeypatch):
    ...
    # --- Constants ---
    PLANTPREDICT_FILE_NAME = "_plantpredict_combiner.csv"
    ...
    simulation_outputs = simulation_outputs[simulation_outputs["device_id"] == 785]
