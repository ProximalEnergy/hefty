...
class SensorType(BaseIntEnum):
    ...
    BESS_MV_COLLECTOR_CIRCUIT_METER_DELIVERED_ENERGY = 154
    PV_MV_COLLECTOR_CIRCUIT_METER_CONSUMED_ENERGY = 155
    BESS_MV_COLLECTOR_CIRCUIT_METER_DELIVERED_REACTIVE_ENERGY = 156
    BESS_MV_COLLECTOR_CIRCUIT_METER_CONSUMED_REACTIVE_ENERGY = 157
    ...
    BESS_MV_COLLECTOR_CIRCUIT_METER_CONSUMED_ENERGY = 216
