...
class FailureModeEnum(BaseDatabaseEnum[int], IntEnum):
    _db_table = nonmember("operational.failure_modes")  # type: ignore[misc]
    _db_id_column = nonmember("failure_mode_id")  # type: ignore[misc]
    _db_name_column = nonmember("name_short")  # type: ignore[misc]
...
# Issue categories are defined in operational.issue_categories, but
